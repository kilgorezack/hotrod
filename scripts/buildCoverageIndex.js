...
// Output as a JS module (not JSON) so bundlers trace and include it automatically.
const OUT  = path.join(HERE, '..', 'server', 'data', 'coverageIndex.js');
...
async function main() {
  ...
  // Wrap in a JS module export so bundlers (Vercel nft, esbuild, etc.) can
  // statically trace the import and include the data without any fs.readFile calls.
